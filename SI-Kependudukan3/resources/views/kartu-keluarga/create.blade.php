    ...
    <form action="{{ route('kartu-keluarga.store') }}" method="POST">
        ...
        <div class="space-y-4">
            <div>
                ...
                <select name="kepala_keluarga_nik" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('kepala_keluarga_nik') border-red-500 @enderror">
                    ...
                    @foreach($penduduk as $p)
                        <option value="{{ $p->nik }}" {{ old('kepala_keluarga_nik') == $p->nik ? 'selected' : '' }}>
            ...
            <div>
                ...
                <input type="text" name="alamat" value="{{ old('alamat') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('alamat') border-red-500 @enderror">
                @error('alamat')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="rt" value="{{ old('rt') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('rt') border-red-500 @enderror">
                    @error('rt')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="rw" value="{{ old('rw') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('rw') border-red-500 @enderror">
                    @error('rw')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
