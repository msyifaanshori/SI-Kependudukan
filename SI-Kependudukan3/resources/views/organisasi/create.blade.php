...
@section('title', 'Tambah Organisasi - SI Kependudukan')

@section('content')
<div class="bg-white p-6 md:p-8 rounded-lg shadow-md max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Data Organisasi</h1>
    ...
    <form action="{{ route('organisasi.store') }}" method="POST">
        ...
        <div class="space-y-4">
            <div>
                ...
                <input type="text" name="nama_organisasi" value="{{ old('nama_organisasi') }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('nama_organisasi') border-red-500 @enderror">
